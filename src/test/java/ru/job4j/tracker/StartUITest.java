...
/*
    ...
    public void whenDeleteItem() {
        ...
        String[] answers = {String.valueOf(item.getId())};//4а. и созд массив с ответами.
        StartUI.deleteItem(new StubInput(answers), tracker); //5. Удал объект с заданным
                                                                    в StubInput(answers) ID
